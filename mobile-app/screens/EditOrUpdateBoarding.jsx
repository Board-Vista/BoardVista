...
const styles = StyleSheet.create({
  ...
  imagePickerContainer: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 10, marginBottom: 8 },
  imagePickerButton: { flex: 1, backgroundColor: '#2563EB', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 12, borderRadius: 10, marginRight: 10 },
  cameraButton: { backgroundColor: '#25D366', marginRight: 0 },
  imagePickerButtonText: { color: '#fff', fontWeight: '700', marginLeft: 8, fontSize: 13 },
