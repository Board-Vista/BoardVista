            ...
            <View style={styles.detailsCard}>
              ...
              <View style={styles.actionButtonsContainer}>
               <TouchableOpacity style={[styles.questionButton, { backgroundColor: '#25D366', borderColor: '#25D366' }]}
                           onPress={() => {
                             const ownerPhone = currentBoarding?.contact?.phone || '+94771234567';
...
const styles = StyleSheet.create({
  ...
  questionButton: { backgroundColor: '#f8f9fa', borderWidth: 1, borderColor: '#dee2e6', borderRadius: 12, padding: 12, width: '100%', alignItems: 'center', marginBottom: 10 },
